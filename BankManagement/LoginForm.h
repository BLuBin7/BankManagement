...
//    try
//    {
//        // Connect to the database and perform the query to retrieve the account name
//        SqlConnection^ connection = gcnew SqlConnection(connectionString);
//        connection->Open();
//
//        String^ selectQuery = "SELECT ten FROM TaiKhoan WHERE ten = '" + userBox->Text + "';";
...
//    catch (Exception^ ex)
//    {
//        MessageBox::Show("Failed to retrieve the logged-in account name", "Error", MessageBoxButtons::OK);
//    }
//
//    return ""; // Return an empty string if the account name cannot be retrieved
//}
//		//private: System::Void loginButton_Click(System::Object^ sender, System::EventArgs^ e) {
...
//		//			String^ loggedInAccount = GetLoggedInAccountName();
//
//		//			// Create an instance of the Dashboard form
//		//			Dashboard^ dashboard1 = gcnew Dashboard(loggedInAccount);
//		//
//		//			// Show the Dashboard form
//		//			this->Hide();  // Hide the login form
//		//			dashboard1->ShowDialog();
//
//		//			// Close the application or perform any other necessary actions after the Dashboard form is closed
//		//			this->Close();
//		//		}
//		//		else
//		//		{
...
//
//		//			// Create an instance of the Dashboard form
//		//			Dashboard^ dashboard2 = gcnew Dashboard(loggedInAccount);
//
//		//			// Show the Dashboard form
//		//			this->Hide();  // Hide the login form
...
//			}
//			else if (enteredUsername == "admin2" && enteredPassword == "123") {
//				loggedInAccount = "admin2";
//			}
//			else {
...
//			MessageBox::Show("Login Successfully!");
//
//			// Create an instance of the Dashboard form and pass the logged-in account name
//			Dashboard^ dashboardForm = gcnew Dashboard(loggedInAccount);
//
//			// Show the Dashboard form
//			this->Hide();  // Hide the login form
//			dashboardForm->ShowDialog();
//			dashboardForm->SetAccountDetails("admin");
//			
//
//			// Close the application or perform any other necessary actions after the Dashboard form is closed
//			this->Close();
